...
require('dotenv').config(); //this load the variables we store in .env file so they are directly accessable to process.env.AWSAccessKeyId, 
// store variable like :- AWSAccessKeyId=AFLDJLADLASD
// multiple environment variables without using ( , )
